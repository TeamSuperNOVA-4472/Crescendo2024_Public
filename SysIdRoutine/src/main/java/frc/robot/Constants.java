...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final int kFLTurn = 2;
    public static final int kFRDrive = 3;
    public static final int kFRTurn = 4;
    public static final int kRLDrive = 5;
    public static final int kRLTurn = 6;
    public static final int kRRDrive = 7;
    public static final int kRRTurn = 8;
    ...
    public static final double kPositionConversionFactor = 0.0540809579134;
    public static final double kVelocityConversionFactor = kPositionConversionFactor / 60;
    public static final double kAngleConversionFactor = 16.8;
    public static final double kAngleP = 25;
