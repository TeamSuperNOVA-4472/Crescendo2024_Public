...
public class RobotContainer {
  ...
  private static final PathPlannerPath m_path = PathPlannerPath.fromPathFile("TurnNinety");
  private List<PathPlannerPath> m_auto = PathPlannerAuto.getPathGroupFromAutoFile("Test Auto");
  ...
  public Command getAutonomousCommand() {
    return new SequentialCommandGroup(
      new InstantCommand(
        () -> m_drivetrain.resetPose(m_path.getStartingDifferentialPose())),
